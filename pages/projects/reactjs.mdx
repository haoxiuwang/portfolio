---
title: 'FReact, an analogue of reactjs'
subtitle: 'Prism with Next.js subtitle'
date: '2020/01/16'
description: 'These are what I call <u>freact</u>, an anologue of <u>reactjs framework</u> ...'
image: '/assets/images/reactjs.png'
tags:
  - "js"
  - "reactjs"
  - "nodejs"
github: "https://github.com/wangfei20/freact/blob/master/freact.js"
demo: "github"
---

 `freact`, my own `reactjs`, is the most complicated one of all the Javascript framework I've rewrited, with so many codes that I have to beg you to read it patiently.
