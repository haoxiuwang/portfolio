---
title: 'Rewrite Hexo Framework'
subtitle: 'Prism with Next.js subtitle'
date: '2020/1/14'
description: "My <u>Hexo</u> in very concise code reveals the real <u>Hexo framework</u>'s core logics ..."
image: '/assets/images/hexo.png'
tags:
  - "hexo"
  - "markdown"
  - "nodejs"
github: "https://github.com/wangfei20/nodejs-lab/blob/master/hexo/hexo.js"
demo: "github"
---

The codes are too long, because Hexo involve too much businesses.

```nodejs
var { pipeline, Router } = require("../express/pipeline.js")
var fs = require("fs")
