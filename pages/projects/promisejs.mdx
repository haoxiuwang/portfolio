---
title: 'Rebuild JavaScript Promise'
subtitle: 'Prism with Next.js subtitle'
date: '2020/07/11'
description: 'This source code simulates the inner workings of **Javascript Promise** in very concise code...'
...
demo: "github"
---
How do JavaScript Promise or "Bluebird" resolve the problem of `asynchronous` invoking, let me show that with my code.
```nodejs
