  ...
  return (
    <div className="navbar mb-16 flex place-content-between place-items-center p-4 shadow-lg bg-neutral text-neutral-content sticky top-0 z-10">
      ...
      <div className="flex-1 px-2 mx-2">
        <Link className="text-lg font-bold" href="/">Portfolio and Blog
        </Link>
      </div>
      <div className="dropdown dropdown-left hidden">
        <div tabIndex="0" className="m-1 btn">Links
        </div>
        <ul tabIndex="0" className="bg-neutral rounded-box shadow text-neutral-content p-2 w-52 menu dropdown-content ">
